...
IL_002c:
	{
		...
		uintptr_t L_13 = (il2cpp_codegen_conv<uintptr_t,uint8_t*,intptr_t,false,false>(((L_12)->GetAddressAtUnchecked(static_cast<il2cpp_array_size_t>(0))),NULL));
		V_2 = (uint8_t*)L_13;
	}
...
IL_003a:
	{
		...
		(L_15)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_16), (ControlBitRangeNode_t21274A438B0E0877F1495EC579EB1DAF81B1A6B0)L_20);
		int32_t L_21 = V_4;
